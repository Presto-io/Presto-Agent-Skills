...
**Latest shipped milestone:** v1.15 teaching-design-package 模块化渲染与旧格式回归

**Shipped:** 2026-06-15

**Active milestone:** None

**Status:** v1.15 shipped and archived. The repository is ready for the next milestone definition.

**Delivered in v1.15:**
- `teaching-design-package` now derives hidden module Markdown and Typst from the unified Markdown through a package-owned module registry.
- The teaching-plan and teaching-design PDFs are generated by package-owned migrated formal renderers without runtime sibling-skill dependency.
- A single scheduling model owns calendar, hours, task/activity mapping, and cross-module validation evidence.
- Successful public delivery uses course-name-prefixed `1 + 1 + N` Markdown/PDF files only, with hidden diagnostics and honest failure behavior.
...
---
*Last updated: 2026-06-15 after v1.15 milestone archive*
