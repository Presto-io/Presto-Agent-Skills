...
`school-pptx` converts reviewed structured Markdown into editable, layout-stable, template-consistent PPTX files, with deterministic pagination, bounded verification, six-runtime guidance, and hash-bound human viewer acceptance.
