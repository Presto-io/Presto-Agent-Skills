# Requirements Archive: v1.7 End-of-Term Teaching Materials Skill

**Archived:** 2026-06-10
**Status:** SHIPPED

The root `.planning/REQUIREMENTS.md` was removed at close. The next milestone should create a fresh requirements file.
