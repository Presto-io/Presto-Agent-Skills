...
- [ ] **Phase 46: 资料契约、字体与可验证夹具** - 建立主题无关、可验证的简历资料与离线 CLI 基线。
- [ ] **Phase 47: 受控主题、照片与冻结布局** - 让同一资料在三种主题下稳定收敛为 1/2 页 A4 简历。
...
Plans:
- [ ] 46-01: 定义 skill-local schema、稳定事实 ID 与受限校验规则。
- [ ] 46-02: 建立离线 CLI 命令边界、目标资料输入、固定依赖和受控 CJK 字体。
- [ ] 46-03: 建立正常、多目标与资料错误 fixtures，作为后续阶段基线。
...
|-------|----------------|--------|-----------|
| 46. 资料契约、字体与可验证夹具 | 0/3 | Not started | - |
| 47. 受控主题、照片与冻结布局 | 0/3 | Not started | - |
