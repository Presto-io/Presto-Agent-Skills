...
This phase covers TDBR-01 through TDBR-05:
...
Three final PDFs and standalone parity are Phase 29 scope.
...
7. Generate one package Typst artifact named `teaching-design-package.typ` through `teaching-design-package.sh render-package`.
8. Record provenance in manifest or sidecar evidence with at least:
   - `source_markdown`
...
9. Leave Phase 29 PDF slots explicit:
   - `teaching-plan.pdf`
   - `lesson-plans.pdf`
